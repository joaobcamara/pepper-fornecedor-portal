...
- [ ] webhooks Tiny apontando para o Render
...
- [x] `/admin/estoque`
- [x] `/admin/produtos`
- [ ] importacao sob demanda dentro de `Produtos`
- [x] `/admin/financeiro`
- [x] `/admin/whatsapp`
- [x] `/admin/conversas`
...
- [ ] Pepper IA mobile sem cobrir menu
- [ ] dashboard de estoque legivel no desktop e mobile
- [ ] modais de pedido e financeiro com botoes de baixar arquivo
- [ ] cards e modais do WhatsApp legiveis no celular
