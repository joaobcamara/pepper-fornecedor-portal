          ...
          <div className="max-h-[92vh] w-full max-w-6xl overflow-y-auto rounded-[2rem] border border-white/60 bg-white/95 p-6 shadow-panel">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-semibold text-slate-900">{selected.productName}</h3>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-2xl border border-[#f3d0bd] bg-[#fff5ef] px-4 py-3 text-sm font-semibold text-[#a94b25]"
              >
