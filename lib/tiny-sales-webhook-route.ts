...
export function resolveTinyWebhookAccountKey(request: Request): TinyAccountKey {
...
export function buildTinyWebhookPingResponse(webhook: "sales" | "orders", accountKey?: TinyAccountKey) {
  return NextResponse.json({
    ok: true,
    webhook,
    account: accountKey ?? "dynamic"
  });
}
